...
class SystemRuns:
    ...
    def start(self):
        ...
        for i in range(self.data['number_runs']):
            ...
            total_waiting_pass_destination, total_passengers_in_elevators, average_time_of_waititng, total_trips, total_passengers = elevator_system_run.report_statistics()     
