class Elevator:
    ...
    def move_to_floor(self, target_floor):
        ...
        self.activitiesStatistics.append_acivities_statistics(before_timer_counter, self.timer_counter, 1)        
    ...
    def load_unload_passengers(self):
        ...
        self.activitiesStatistics.append_acivities_statistics(before_timer_counter, self.timer_counter, 0)        
